...
<body>
		...
		<div id="tableMemberList" class="mt-4">
			<table class="table table-bordered table-hover">
				...
				<c:if test="${memberNickNameList.jmNickName != null}">
				<tbody>
						<tr>
							<td>${memberNickNameList.jmId}</td>
							<td>${memberNickNameList.jmName}</td>
							<td>${memberNickNameList.jmNickName}</td>
							<td>${memberNickNameList.jmGender}</td>
							<td>${memberNickNameList.jmTel}</td>
							<td>${memberNickNameList.memRegitstDate}</td>
						</tr>
				</tbody>
				</c:if>
			</table>
