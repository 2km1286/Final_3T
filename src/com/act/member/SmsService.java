...
public class SmsService 
{
	...
	public void sendSMS() 
	{
		...
		String requestUrl= "https://sens.apigw.ntruss.com/sms/v2/services/{ncp:sms:kr:313505171367:test}/messages";                   		// 요청 URL
		String requestUrlType = "/messages";                      		// 요청 URL
		String accessKey = "45X1zvbTYGX85ZY5jsM5";                     	// 네이버 클라우드 플랫폼 회원에게 발급되는 개인 인증키			// Access Key : https://www.ncloud.com/mypage/manage/info > 인증키 관리 > Access Key ID
		String secretKey = "h9F7bIX3Rr9jYe1xaZDT4VXcTqjRoxPWi7S2nWAM";  // 2차 인증을 위해 서비스마다 할당되는 service secret key	// Service Key : https://www.ncloud.com/mypage/manage/info > 인증키 관리 > Access Key ID	
		String serviceId = "ncp:sms:kr:313505171367:test";       		// 프로젝트에 할당된 SMS 서비스 ID							// service ID : https://console.ncloud.com/sens/project > Simple & ... > Project > 서비스 ID
		...
		List<Map<String, Object>> toArr = new ArrayList<>();
	    ...
	    toJson.put("to","01083411286");						// Mandatory(필수), messages.to	수신번호, -를 제외한 숫자만 입력 가능
	    toArr.add(toJson);
	    ...
	    bodyJson.put("from","01083411286");					// Mandatory, 발신번호, 사전 등록된 발신번호만 사용 가능		
