...
<body>
	...
	<div class="all">
		<div class="card">
			...
			<div class="card-body recc" style="display: flex; justify-content: center;">
				<div class="row row-cols-1 row-cols-md-3 g-4">
					<div class="col rec">
						<div class="card h-100" style="width: 25rem; height: 550px;">
							<img src="./images/welcome-registerpet.png"
								class="card-img-top hover-shadow" alt="welcome-registerpet" />
							<div class="card-body">
								<h5 class="card-title">반려견 등록하기</h5>
								<p class="card-text">
									저희 '맡겨보개'의 서비스를 이용하기 위해서 <br /> ooo님의 반려견을 등록해주세요!
								</p>
							</div>
					...
					<div class="col rec">
						<div class="card h-100" style="width: 25rem; height: 550px;">
							...
							<div class="card-body">
								...
								<p class="card-text">
									대리산책러가 되어서 수익활동을 해보세요! <br /> 귀여운 강아지들과 친구가 될 수 있어요
								</p>
							</div>
							<div class="card-footer">
