...
<div class="row all text-center">
	<div class="container">
		<div class="card questions row d-flex justify-content-center">
			<div class="card-body">
			<h3 class="card-header">OOO님의 대리산책 검증 시험</h3>
				
				<div class="card border border-primary shadow-0 mb-3 q"  >
				  <div class="card-header">문제1</div>
				 ...
				 <br />
				 <div class="btn btn-primary">제출</div>
