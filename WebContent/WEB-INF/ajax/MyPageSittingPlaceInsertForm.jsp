...
<form action="<%=cp%>/insertPlace.action" id="placeForm" enctype="multipart/form-data" method="post">
	<div class="bg-light">
		<div class="container">
			<div class="row">	
				<div class="col-md"><span class="badge">돌봄장소 등록하기</span></div>
			</div>
				...
				<div class="cal-md">
					...
					<span class="smallTitle" style="font-size: 15pt;">돌봄장소 설정</span>
					<div class="mb-3">
						<label for="title" class="form-label">제목</label> 
						<input type="text" class="form-control" id="title" name="sptitle" placeholder="제목을 입력해주세요."
						style="width: 700px;">
					</div>
					...
					<div>
						...
						<div class="">
							...
							onclick="execDaumPostcode()" readonly="readonly" style="width:300px; cursor: pointer;"><br>
							<input type="text" id="extraAddr" name="extraAddr" placeholder="지역검색태그" readonly="readonly">
						</div><br>
						<div class="">
							<label for="spAddr2">상세주소</label><br>
							<input type="text" id="spAddr2" name="spAddr2" placeholder="상세주소" style="width:500px;">
						</div>
					</div>
				...
				<div class="button-container">
					<button type="button" class="detailBtn" id="insertPlace">돌봄장소 등록하기</button>
				</div>
				<br>
			</div>
		</div>
